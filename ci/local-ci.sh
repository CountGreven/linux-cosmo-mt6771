...
make O="$out/build" defconfig >/dev/null
make O="$out/build" DT_SCHEMA_FILES="interrupt-controller/mediatek,mt6577-sysirq.yaml vendor-prefixes.yaml arm/mediatek.yaml display/panel/novatek,nt36672.yaml" dt_binding_check
