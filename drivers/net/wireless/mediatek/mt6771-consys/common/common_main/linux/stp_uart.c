 ...
 */
static INT32 stp_uart_tty_ioctl(struct tty_struct *tty, unsigned int cmd, unsigned long arg)
{
	INT32 err = 0;
...
static __poll_t stp_uart_tty_poll(struct tty_struct *tty, struct file *filp, poll_table *wait)
{
	return 0;
}
